    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link href="/teacher/problems/new" className="btn-primary">
            + 새 문제 출제
          </Link>
        </div>
        ...
        {!loading && problems.length === 0 && (
          <div className="card text-center py-16">
            ...
            <Link href="/teacher/problems/new" className="btn-primary inline-block mt-4">
              문제 출제하기
            </Link>
          </div>
        )}
              ...
              <div className="card hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex justify-between items-start">
                  <div className="flex-1 min-w-0">
                    <h2 className="text-lg font-semibold text-gray-800 truncate">{problem.title}</h2>
                  ...
                  <span className="ml-4 text-blue-600 text-sm font-medium whitespace-nowrap">
                    답안 보기 →
                  </span>
                </div>
              </div>
